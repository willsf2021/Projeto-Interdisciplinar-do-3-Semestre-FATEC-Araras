    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('proteinas', models.DecimalField(decimal_places=2, help_text='Valor por 100g', max_digits=8, verbose_name='Proteínas (g)')),
                ('carboidratos', models.DecimalField(decimal_places=2, help_text='Valor por 100g', max_digits=8, verbose_name='Carboidratos (g)')),
                ('acucares_totais', models.DecimalField(decimal_places=2, help_text='Valor por 100g', max_digits=8, verbose_name='Açúcares Totais (g)')),
                ('acucares_adicionados', models.DecimalField(decimal_places=2, help_text='Valor por 100g', max_digits=8, verbose_name='Açúcares Adicionados (g)')),
                ('gorduras_totais', models.DecimalField(decimal_places=2, help_text='Valor por 100g', max_digits=8, verbose_name='Gorduras Totais (g)')),
                ('gorduras_saturadas', models.DecimalField(decimal_places=2, help_text='Valor por 100g', max_digits=8, verbose_name='Gorduras Saturadas (g)')),
                ('gorduras_trans', models.DecimalField(decimal_places=2, help_text='Valor por 100g', max_digits=8, verbose_name='Gorduras Trans (g)')),
                ('fibra_alimentar', models.DecimalField(decimal_places=2, help_text='Valor por 100g', max_digits=8, verbose_name='Fibra Alimentar (g)')),
                ('sodio', models.DecimalField(decimal_places=2, help_text='Valor por 100g', max_digits=8, verbose_name='Sódio (mg)')),
