    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('estudante', 'Estudante'), ('profissional', 'Profissional'), ('professor', 'Professor')], max_length=20, verbose_name='Tipo de Usuário')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('habilitar_rotulo_nutricional', models.BooleanField(default=False, verbose_name='Habilitar Rótulo Nutricional')),
                ('formato_rotulo', models.CharField(choices=[('vertical', 'Vertical'), ('horizontal', 'Horizontal'), ('quebrado_vertical', 'Quebrado Vertical'), ('quebrado_horizontal', 'Quebrado Horizontal')], default='vertical', max_length=20, verbose_name='Formato do Rótulo')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Criado em')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Atualizado em')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('arquivo_pdf', models.FileField(blank=True, help_text='PDF contendo ficha técnica, rótulos e precificação', null=True, upload_to='documentos/%Y/%m/', verbose_name='Arquivo PDF')),
                ('formato_documento', models.CharField(choices=[('completo', 'Completo (Receita + Rótulo)'), ('rotulo_apenas', 'Apenas Rótulo Nutricional'), ('receita_apenas', 'Apenas Receita')], default='completo', max_length=20, verbose_name='Formato do Documento')),
