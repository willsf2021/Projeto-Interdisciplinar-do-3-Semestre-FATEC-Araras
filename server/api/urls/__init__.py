...
urlpatterns = usuario_urls + alimento_taco_urls + google_auth_urls + receita_urls + ingrediente_urls + documento_urls + rotulo_nutricional_urls + cliente_urls + change_password_urls + recovery_password_urls