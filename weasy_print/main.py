...
BASE_PATH2='C:/Users/renan/Documents/VSCode/Projeto-Interdisciplinar-do-3-Semestre-FATEC-Araras/weasy_print/'
...
css_doc4 = CSS(string=horizontal_quebrado)
...
HTML(f"{BASE_PATH2}rotulo_quebrado.html").write_pdf(f"{BASE_PATH2}horizontal_quebrado.pdf", stylesheets=[css_doc4])